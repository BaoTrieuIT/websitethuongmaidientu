		...
		<div class="inner-top__main wrapper">
			<div class="inner-top__cols">
				...
				<div class="inner-top__right">
					<div class="inner-top__image rounded" data-bg="https://cdn.pixabay.com/photo/2019/07/14/16/29/pen-4337524_1280.jpg"></div>
				</div>
			</div>
						...
						<section class="widget js-slidedown">
							...
							<div class="widget__hide js-slidedown-hide">
								<div class="range">
									...
									<input type="hidden" id="min-price" name="minPrice" value="" />
									<input type="hidden" id="max-price" name="maxPrice" value="" />
								</div>
							</div>
						</section>
			...
			<div class="shop__right">
				...
				<div id="content-container">
					<div class="inner-catalog">
						<c:forEach var="item" items="${pageAll.content}">
					...
					<c:choose>
						<c:when test="${search}">
							<div class="page-nav__col">
								<a class="page-nav__button prev-button" href="/home/search?p=${pageAll.number-1}"></a>
							</div>
							<div class="page-nav__col">
								<ul class="page-nav__list">
									<c:forEach var="pageNumber" begin="0" end="${pageAll.totalPages - 1}">
										<li class="page-nav__item">
											<a class="page-nav__link" href="/home/search?p=${pageNumber}">${pageNumber}</a>
										</li>
									</c:forEach>
								</ul>
							</div>
							<div class="page-nav__col">
								<a class="page-nav__button next-button" href="/home/search?p=${pageAll.number+1}"></a>
							</div>
						</c:when>
						<c:otherwise>
							<div class="page-nav__col">
								<a class="page-nav__button prev-button" href="/home/shop?p=${pageAll.number-1}"></a>
							</div>
							<div class="page-nav__col">
								<ul class="page-nav__list">
									<c:forEach var="pageNumber" begin="0" end="${pageAll.totalPages - 1}">
										<li class="page-nav__item">
											<a class="page-nav__link" href="/home/shop?p=${pageNumber}">${pageNumber}</a>
										</li>
									</c:forEach>
								</ul>
							</div>
							<div class="page-nav__col">
								<a class="page-nav__button next-button" href="/home/shop?p=${pageAll.number+1}"></a>
							</div>
						</c:otherwise>
					</c:choose>
